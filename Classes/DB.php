        ...
        if($this->_query = $this->_pdo->prepare($sql)) {
            ...
            if(count($params)) {
                ...
                foreach($params as $param) {
                    ...
                    /* FROM Documentation: 
                    Parameter identifier. For a ]`-98 statement using named placeholders, this will be a parameter name of the form :name. For a prepared statement using question mark placeholders, this will be the 1-indexed position of the parameter.
